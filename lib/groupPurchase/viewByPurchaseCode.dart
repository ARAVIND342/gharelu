...
import 'package:gharelu/groupPurchase/viewItems.dart';

class ViewByPurchaseCode extends StatefulWidget {
  @override
  _ViewByPurchaseCodeState createState() => _ViewByPurchaseCodeState();
}

class _ViewByPurchaseCodeState extends State<ViewByPurchaseCode> {
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => ViewItems(
                                codeController.text, valueSelected, value1)));
                    print('clicked');
                  })
            ],
          ),
